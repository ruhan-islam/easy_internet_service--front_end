              ...
              <div style="padding: 5%">
                ...
                <ul>
                  <li>
                    ...
                    become known to the third party, as all transmitted data is
                    encrypted by the TLS protocol.
                  </li>
                  <li>
                    For VISA, MC and NEXXUS, look at the back side of your card
                    to find 3-digit CVV2/ CVC2/ CVN2.
                  </li>
                  <li>
          ...
          <v-img height="100%">
            ...
            <v-form ref="form08" v-model="validNagadNo" lazy-validation>
              ...
              <v-row style="padding:0% 5%">
                ...
                <v-col>
                  <v-btn
                    :disabled="accntnumber === '' || !validNagadNo || !tcNagad"
                    width="50%"
        ...
        >
          <v-img height="100%">
            ...
            <v-form ref="form09" v-model="validNagadOTP" lazy-validation>
              ...
              >
                Didn't receive code?
                <strong style="text-decoration:underline" @click="resendTextSet"
                  >Resend code</strong
                >
                <br /><strong>{{ resendText }}</strong>
              </p>
          ...
          <v-img height="100%">
            ...
            <v-form ref="form10" v-model="validNagadPIN" lazy-validation>
              ...
              <v-row style="padding:10% 5% 0%">
                <v-col>
                  <v-btn width="50%" @click="pageInfo = 'nagadOTP'">back</v-btn>
                </v-col>
                <v-col>
                  <v-btn
          ...
          <v-img height="100%">
            ...
            <v-form ref="form11" v-model="validNagadNo" lazy-validation>
              ...
              <v-row style="padding:0% 10%">
                ...
                <v-col>
                  <v-btn
                    :disabled="accntnumber === '' || !validNagadNo || !tcRocket"
                    width="50%"
